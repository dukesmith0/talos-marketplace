---
name: hub-analyzer
description: Analyze tag hub health across 5 quality dimensions. Use with /loci-hub for deep-dive analysis.
...
## Process
1. Run `loci stats` via Bash for precomputed metrics
