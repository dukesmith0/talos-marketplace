---
name: talos-consolidate
description: "Code: Compress .talos/ project files for token efficiency. Run manually when files exceed ~200 lines."
---

# /talos-consolidate — Compress .talos Files

## Steps
1. Read all `.talos/` files: index.md, plan.md, bugs.md, decisions.md, risks.md
