...
# /loci-plan — Decompose Task into Plan

## Step 0
Run `loci vault` via Bash.

## Step 1: Gather Context
1. Read `.loci/index.md`, `.loci/plan.md`, `.loci/decisions.md`, `.loci/bugs.md`, `CLAUDE.md`
...
## Step 3: Plan
Dispatch `loci-code:planner` agent with task + context + hub insights.
...
Write to `.loci/plan.md`:
- Items completable in one sitting
- Dependencies between items
- Complexity: [simple], [moderate], [complex]

## Output
Display plan. Ask for approval. Log: `loci log "plan: <brief outcome>"`
