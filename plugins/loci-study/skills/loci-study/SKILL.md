...
## Tutoring
Dispatch `loci-study:tutor` agent with the topic, proficiency level, and course context.
...
## Activity Log
Run via Bash: `loci log "study: <brief outcome>"`
