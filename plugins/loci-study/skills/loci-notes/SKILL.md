...
# /loci-notes — Capture Course Notes
...
2. QMD `query` for the course name and topic to find related materials. Read top results.
...
## Activity Log
Run via Bash: `loci log "notes: <brief outcome>"`
